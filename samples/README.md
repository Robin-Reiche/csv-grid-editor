...
| `multiline.csv` | 5 | Cells with line breaks inside them, both LF and CRLF, one of them next to a comma and a quote. Toggle **Wrap multi-line cells** in the toolbar, and edit a cell with Alt+Enter. |
