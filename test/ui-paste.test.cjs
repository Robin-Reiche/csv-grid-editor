...
// when the file is read. Paste goes through the same parser, and for a while it
// took that rule along: pasting spaces into a cell did nothing, and the last
// row of a pasted block was skipped when it held only spaces. On the clipboard
