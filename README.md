...
- **Settings menu** - The gear at the right end of the toolbar holds the small display switches, in the editor rather than in the VS Code settings. Each one is remembered across files and sessions.
